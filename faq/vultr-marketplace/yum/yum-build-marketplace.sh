...
then
    wget https://raw.githubusercontent.com/vultr/vultr-docs/main/faq/vultr-marketplace/yum/yum-setup.sh
fi

if [ ! -f /tmp/marketplace.json ]
then
    wget https://raw.githubusercontent.com/vultr/vultr-docs/main/faq/vultr-marketplace/yum/yum-marketplace.json
fi

## Build a snapshot in your Vultr account.
packer build /tmp/yum-marketplace.json
